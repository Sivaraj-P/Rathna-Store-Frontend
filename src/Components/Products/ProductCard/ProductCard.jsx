...
const ProductCard = ({ product }) => {
  ...
  const handleAddToCartBtn = () => {
    ...
    if (isTargetedProductAlreadyExist) {
      ...
      targetedProduct.total = targetedProduct.price;
    }

    setCartItems([targetedProduct, ...latestCartItems]);
    handlelocalStorage("set", "cartItems", [
      targetedProduct,
      ...latestCartItems,
    ]);
        ...
        >
          ...
          <div className="p-1.5">
            <CardContent className="md:space-y-2 space-y-1.5 ">
              {/* title */}
              <h3 className="sm:text-lg  md:text-xl lg:text-2xl text-xl text-gray-700 font-semibold text-center capitalize">
                {name}
              </h3>
